                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT id, fullname, email, role FROM users where role='employee'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                            <a href='javascript:void(0)' onclick='deleteEmployee(" . $row['id'] . ")' class='btn btn-sm btn-danger'>Delete</a>
                                        </td>";
                                    echo "</tr>";
                                }
                            } else {
